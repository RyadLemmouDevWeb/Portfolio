  ...
  const def = [
    {
      ...
      images: [
        ...
        'src/assets/Twitter3.png',
        'src/assets/Twitter4.png',
        'src/assets/Twitter5.png',
        'src/assets/Twitter6.png',
        'src/assets/Twitter7.png'
      ]
    },
    {
      title: 'MyCinema',
      ...
      images: [
        "src/assets/Cinema1.png",
        "src/assets/Cinema2.png",
        "src/assets/Cinema3.png",
        "src/assets/Cinema4.png"
      ]
    },
    {
      title: 'Puissance4',
      ...
      images: [
        'src/assets/Puissance4_1.png',
        'src/assets/Puissance4_2.png',
        'src/assets/Puissance4_3.png',
        'src/assets/Puissance4_4.png'
      ]
    }
  ];
