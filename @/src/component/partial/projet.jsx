...
export default function Projet() {
  const def = [
    [
      ...
      './public/assets/Capture d’écran 2025-03-25 à 10.36.22.png',
    ],
    [
      'MyCinema',
      ...
      './public/assets/Capture d’écran 2025-03-24 à 11.41.09.png',
    ],
    ...
    [
      ...
      './public/assets/Capture d’écran 2025-03-25 à 10.43.06.png',
    ],
  ];
  return (
    <div id="Projet">
